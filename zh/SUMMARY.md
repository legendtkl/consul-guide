...
* [5. Consul Agent](agent/README.md)
    * [5.1 启动和关闭](agent/running_and_stopping.md)
    * [5.2 DNS 接口](agent/dns_interface.md)
    * [5.3 HTTP API](agent/http_api.md)
    * [5.4 配置](agent/configuration.md)
    * [5.5 服务定义](agent/service_definitions.md)
    * [5.6 健康检测定义](agent/check_definitions.md)
    * [5.7 网络传输加密](agent/encryption.md)
    * [5.8 RPC 协议](agent/rpc_protocol.md)
    * [5.9 信息检测](agent/telemetry.md)
    * [5.10 Watches](agent/watches.md)
* [6. Guides](guides/README.md)
    * [6.1 Atlas Integration](guides/atlas_integration.md)
    * [6.2 添加/删除 Servers](guides/add_remove_servers.md)
